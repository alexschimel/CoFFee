...
%   based on the sample index, sample start index offset (if any),
%   inter-samples distance, beam pointing angle and the sonar's projected
%   coordinates and orientation (heading).
%
