...
% 2014-08-13 : Alex modification to avoid error
...
% !!ALEX ADD !!
% if "extremos" has not found any peak through columns, smaxcol and smincol
% are empty and "smaxcol(:,1)" in the command after returns an error. To
% avoid this, return empty outputs now.
if isempty(smaxcol)
    xymax=[];
    smax=[];
    xymin=[];
